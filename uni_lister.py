...
def data_spliter(unis):
    ...
    for i in unis:
        ...
        city, u_type, pay, t_type = x[5].replace("İndirimli ", "").rsplit(" ", 4)[-4:]
...
def find_and_next():
    ...
    while True:
        ...
        try:
            university_informations = browser.find_elements_by_css_selector('#mydata > tbody > tr')
...
def getArguments():
    ...
    parser.add_argument("--quit", help="Give 1 if you want to exit when an error occurs")
...
if __name__ == '__main__':
    ...
    if (args.driver) and (args.database):
        ...
        try:
            ...
            browser.execute_script('document.getElementById("top-link-block").remove();')
